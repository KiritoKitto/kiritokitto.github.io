...
Questo sito è nato per puro divertimento e non ho ancora deciso per cosa usarlo. Per ora lo userò per condividere i post troppo lunghi per un messaggio Telegram. Qui potete leggere la [storia di questo blog](https://kiritokitto.bearblog.dev/blogcreation/).
